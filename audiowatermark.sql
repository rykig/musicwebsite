...
--
-- Cơ sở dữ liệu: `audiowatermark`
--
CREATE DATABASE IF NOT EXISTS `audiowatermark` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `audiowatermark`;
...
('Watermarking', 'Dương Quang Khang-N14DCAT008', 'audio, watermark, demo', 'Audio Watermarking', 'https://www.facebook.com/rykig', 'logo', '{companyname} © 2018', '');
