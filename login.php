...
<head>
  ...
  <style>
	...
	#loginbox .panel-heading{ background-color: #8080ff;}
	        		...
	        		<div id="loginform" class="form-horizontal" rule="form">
	          			...
	          			<div class="form-group">
	            			<div class="col-md-12 col-xs-12 control">
	              				<div style="border-top: 1px solid #888; padding-top: 15px; font-size: 85%" ><a href="#signupbox" onClick="$('#loginbox').hide(); $('#signupbox').show()">Đăng ký</a>
	              				</div>
		            		</div>
		          		</div>
		        	</div>
	    	...
	    	<div class="panel panel-info">
	      		...
	      		<div class="panel-body" >
	        		<div id="signupform" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<div class="col-md-12 col-xs-12 control">
								<div style="border-top: 1px solid #888; padding-top: 15px; font-size: 85%" ><a href="#loginbox" onclick="$('#signupbox').hide(); $('#loginbox').show()">Quay trở lại đăng nhập</a>
							  	</div>
							</div>
						</div>
	        		</div>
	    ...
	    $.ajax({
	      ...
	      success : function(response){
	        ...
	        if (response == "signup success"){
	          alert("Đăng kí thành công! Hãy trải nghiệm âm nhạc cùng chúng tôi!");
	          window.location="";
	        }
